                    ...
                    <tbody>
                        @if($salaries->count())
                            @foreach($salaries as $salary)
                                ...
                                <tr class="{{ $salary->status == 'paid' ? 'table-success' : ($salary->status == 'pending' ? 'table-warning' : '') }}">
                                    ...
                                    <td>
                                        <span class="badge {{ $salary->status == 'paid' ? 'bg-success' : ($salary->status == 'pending' ? 'bg-warning text-dark' : 'bg-secondary') }}">
